<?php
/**
 * A template partial to output pagination for the CMS_NhomE default theme.
 *
 ...
 */
$new_posts_text = __( 'Newer <span class="nav-short">Posts</span>', 'CMS_NhomE' );

/*
 * Translators: This text contains HTML to allow the text to be shorter on small screens.
 * The text inside the span with the class nav-short will be hidden on small screens.
 */
$old_posts_text = __( 'Older <span class="nav-short">Posts</span>', 'CMS_NhomE' );
