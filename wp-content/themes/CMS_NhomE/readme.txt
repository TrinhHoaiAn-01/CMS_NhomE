...
CMS_NhomE WordPress Theme, Copyright 2019-2026 WordPress.org and contributors.
CMS_NhomE is distributed under the terms of the GNU GPL.
...
CMS_NhomE is derived from the Chaplin Theme, Copyright 2019 Anders Norén
Chaplin Theme is distributed under the terms of the GNU GPL version 2.0

CMS_NhomE bundles the following third-party resources:
...
Bespoke Icons Created For CMS_NhomE
License: Creative Commons Zero (CC0), https://creativecommons.org/publicdomain/zero/1.0/
...
- CMS_NhomE_SVG_Icons
- CMS_NhomE_the_theme_svg()
- CMS_NhomE_get_theme_svg()
- CMS_NhomE_nav_menu_social_icons()
