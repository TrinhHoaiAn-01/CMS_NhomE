 ...
 * @return {Object} - this
 */
function _CMS_NhomEColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_CMS_NhomEColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_CMS_NhomEColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_CMS_NhomEColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Returns a new instance of the _CMS_NhomEColor object.
 *
 * @since CMS_NhomE 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function CMS_NhomEColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _CMS_NhomEColor( backgroundColor, accentHue );
