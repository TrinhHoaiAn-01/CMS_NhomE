...
if ( ! class_exists( 'CMS_NhomE_Non_Latin_Languages' ) ) {
	/**
	 * Language handling.
	 *
	 * @since CMS_NhomE 1.0
	 */
	class CMS_NhomE_Non_Latin_Languages {
		...
		public static function get_non_latin_css( $type = 'front-end' ) {
			...
			$font_family = apply_filters(
				'CMS_NhomE_get_localized_font_family_types',
				array(
			...
			$elements = apply_filters(
				'CMS_NhomE_get_localized_font_family_elements',
				array(
			...
			return CMS_NhomE_generate_css( implode( ',', $elements[ $type ] ), 'font-family', implode( ',', $font_family[ $locale ] ), null, null, false );
		}
	}
}
