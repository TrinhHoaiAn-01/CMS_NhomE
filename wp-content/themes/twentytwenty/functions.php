...
function twentytwenty_register_styles() {
	...
	// Font Awesome icons and the custom reference-matched header/footer styles.
	...
	wp_enqueue_style(
		'twentytwenty-module-two',
		get_theme_file_uri( '/module2.css' ),
		array( 'twentytwenty-style', 'font-awesome' ),
		filemtime( get_theme_file_path( '/module2.css' ) )
	);
